...
<html lang="fr">
  ...
  <head>
    ...
    <title>Modifier un vêtement</title>
  ...
  <body>
   	<!--Navigation principale-->
		<nav class="navbar navbar-expand-lg navbar-light bg-light navCalendar">
			<div class="container-fluid">
				<a class="navbar-brand" href="#">Modifier le vêtement</a>
    ...
    <form class="formAdd" action="" method="POST">
      <table class="formClothes">
        ...
        <tr>
          <td colspan="2"> <input type="number" name="maxTemp" value="<?php echo $clothe["tempMin"];?>" required> </td>
        </tr>
        <tr>
