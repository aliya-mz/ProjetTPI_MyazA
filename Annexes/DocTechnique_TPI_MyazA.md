...
Les scénarios ont été écrits avant la réalisation du projet, afin de garantir la réponse aux demandes du cahier des charge. Faire attention aux tests nécessitant un prérequis. Dans le cadre de ce travail, ils ont été exécutés manuellement.
...
| Nom                 | 1.6 Déconnexion (prérequis : scénario 1.2)                   |
| ------------------- | ------------------------------------------------------------ |
| *User story*        | S3 : Déconnexion                                             |
| *Situation*         | Je suis connecté ; Je clique sur *"Déconnexion"* dans la navigation de la page principale ;  ➔ Je suis redirigé vers la page principale, déconnecté. Seuls le bouton "Connexion" est affiché dans la navigation. |
| *Résultats obtenus* |                                                              |
| *Statut*            | X                                                            |

| Nom                 | 1.7 Modifier le compte (prérequis : scénario 1.2)            |
| ------------------- | ------------------------------------------------------------ |
| *User story*        | S5 : Modifier le compte                                      |
| *Situation*         | Je suis connecté ; Je clique sur *"Mon compte"* dans la navigation de la page principale ; sur la page "*Mon compte*" ; Je modifie le champs "**Mail**" par "*nouveau@gmail.com*" ; Je clique sur "*Valider*" ; Je clique sur "*Home*" ; Je re-clique sur *"Mon compte"* ➔ Le champs "**Mail**" contient : "*nouveau@gmail.com*"; |
| *Résultats obtenus* |                                                              |
| *Statut*            | X                                                            |

| Nom                 | 1.8 Voir les utilisateurs (prérequis : scénario 1.3)         |
| ------------------- | ------------------------------------------------------------ |
...
| Nom                 | 1.9 Supprimer un utilisateur (prérequis : scénario 1.1 et 1.3) |
| ------------------- | ------------------------------------------------------------ |
| *User story*        | S4 : Supprimer un utilisateur                                |
...
#### Tests - gestion de la météo - à faire
...
#### Tests - gestion des vêtements - à faire

| Nom                 | 3.1 Ajouter un vêtement |
| ------------------- | ----------------------- |
| *User story*        | S1 : Connexion          |
| *Situation*         |                         |
| *Résultats obtenus* |                         |
| *Statut*            | X                       |
